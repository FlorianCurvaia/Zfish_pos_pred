...
fig2, axs2=plt.subplots(2, 3, figsize=(12, 7.24), sharex=True, sharey=True)
fig2.subplots_adjust(hspace=0.15)
fig2.subplots_adjust(wspace=0.33)

fig4, axs4=plt.subplots(2, 3, figsize=(12, 7.24), sharex=True, sharey=True)
fig4.subplots_adjust(hspace=0.20)
fig4.subplots_adjust(wspace=0.20)
