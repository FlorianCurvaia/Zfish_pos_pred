...
# -*- coding: utf-8 -*-
"""
Created on Tue May 16 12:43:38 2023
...
path_out_im="/Users/floriancurvaia/Desktop/Uni/ETH/Labos/Pelkmans/Images/Posterior/Both_bins/bins_pred/"
...
#stains=['betaCatenin_nuc', 'MapK_nc_ratio'] #'pSmad1/5_nc_ratio',
#stains=['betaCatenin_nuc', 'pSmad1/5_nc_ratio'] # 'MapK_nc_ratio'
#stains=['pSmad1/5_nc_ratio', 'MapK_nc_ratio'] #'betaCatenin_nuc',
#stains=['pSmad1/5_nc_ratio'] #, 'MapK_nc_ratio'
...
for embryo in emb_list:
    ...
    ax.set_yticks(list(range(0, n_bins)), index)  #bins_coord_ticks
    ax.set_xticks(list(range(0, n_bins)), index, rotation=90) #bins_coord_ticks
...
mean_all_preds=np.nanmean(np.array(all_preds), axis=0)
