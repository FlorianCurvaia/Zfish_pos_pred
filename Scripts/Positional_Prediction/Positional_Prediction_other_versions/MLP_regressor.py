...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun 20 15:13:19 2023
...
#path_out_im="/data/homes/fcurvaia/Images/Random_Forest/both_bins/By_hpf/Cells_pred/" 
...
fig.savefig(path_out_im+"rel_theta_MLP_scatter.png", bbox_inches='tight', dpi=300)

fig1, ax1=plt.subplots()
ax1.scatter(y_test.cur_phi, y_pred[:,1], s=1, marker=".")
fig1.savefig(path_out_im+"cur_phi_MLP_scatter.png", bbox_inches='tight', dpi=300)
plt.close()
