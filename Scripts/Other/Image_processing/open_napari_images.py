...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb  1 16:11:47 2023
...
im="D03_px-1972_py+0082" #B07_px+1257_py-0474 B08_px+1076_py-0189 B03_px-0545_py-1946 B05_px+1522_py-1087 B06_px-0493_py+0146

fn="/Users/floriancurvaia/Desktop/Uni/ETH/Labos/Pelkmans/active/fcurvaia/"+im+".h5"
...
with h5py.File(fn) as f:
    for dset in h5_select(f, {'stain': 'pSmad2', 'level': 1, 'cycle': cycle}):
...
with h5py.File(fn) as f:
    for dset in h5_select(f, {'stain': 'pERK', 'level': 1, 'cycle': cycle}):
        MapK = to_numpy(dset)
