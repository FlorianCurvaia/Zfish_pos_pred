...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 21 12:54:31 2023
...
path_out_im="/Users/floriancurvaia/Desktop/Uni/ETH/Labos/Pelkmans/Images/Perfect_embryos/Posterior/Sub_angle/"   #"/Users/floriancurvaia/Desktop/Uni/ETH/Labos/Pelkmans/work/fcurvaia/Images/Posterior/" #"/data/homes/fcurvaia/Images/Pos_inf/"

#path_out_im="/Users/floriancurvaia/Desktop/Uni/ETH/Labos/Pelkmans/Images/Perfect_embryos/Shuffle/Features_and_Labels/Sub_angle/"
...
theta_labels=range(1, n_bins_theta)
...
for f in fld.glob("*.csv"):
    ...
    feat_filt=pd.read_csv(fn, sep=",", index_col=False, usecols=["theta", "phi", "z_corr"]+stains)
    feat_filt["emb"]=emb
...
#feat_filt_all[['theta_bin_pos', 'phi_bin_abs']]=feat_filt_all[['theta_bin_pos', 'phi_bin_abs']].sample(frac=1).values
...
for s in range(len(stains)):
    ...
    for im, e in zip(files, range(0,len(files))):
        ...
        margin_loc=feat_filt.theta.quantile(margin)
        feat_filt=feat_filt.loc[feat_filt.theta>margin_loc]
