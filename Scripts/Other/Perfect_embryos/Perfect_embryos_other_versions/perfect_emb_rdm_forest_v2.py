...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 21 16:29:38 2023
...
path_out_im="/data/homes/fcurvaia/Images/Perfect_embryos/Random_forest/" 
#path_out_im="/data/homes/fcurvaia/Images/Perfect_embryos/Random_forest/Shuffle/Labels_only/"
#path_out_im="/data/homes/fcurvaia/Images/Perfect_embryos/Random_forest/Shuffle/Features_only/"
#path_out_im="/data/homes/fcurvaia/Images/Perfect_embryos/Random_forest/Shuffle/Features_and_Labels/"
...
feat_filt['theta_bin_cv'] = pd.to_numeric(pd.cut(x = feat_filt['theta'], bins = theta_bins, labels = labels, include_lowest = True, right=True))
...
#feat_filt['theta_bin_cv']=feat_filt['theta_bin_cv'].sample(frac=1).values
#feat_filt['phi_bin_abs']=feat_filt['phi_bin_abs'].sample(frac=1).values
#for stain in stains:
#    feat_filt[stain]=feat_filt[stain].sample(frac=1).values
...
for s in range(l): #, axs_sub, axs_conf
    ...
    #ax.set_title(im)
    fig.savefig(path_out_im+col+"_plot_random_forest.png", bbox_inches='tight', dpi=300)
    plt.close()
    ...
    fig.savefig(path_out_im+col+"_conf_mat_random_forest.png", bbox_inches='tight', dpi=300)
    plt.close()
