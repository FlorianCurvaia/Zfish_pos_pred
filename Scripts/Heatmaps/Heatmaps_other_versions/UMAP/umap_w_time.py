...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 15:06:41 2023
...
feat_um["hpf"]=zscore(feat_um["hpf"], nan_policy="omit")
...
for im in images:
    ...
    f1.savefig(path_out_im+im+"_pacmap_w_time.png", bbox_inches='tight', dpi=300)
    plt.close()
