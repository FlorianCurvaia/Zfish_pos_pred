...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  8 13:00:37 2023
...
feat_filt=pd.read_csv(fn1, sep=",", index_col=False, usecols=["Label", "Centroid_x", "Centroid_y", "Centroid_z", "x_corr", "y_corr", "z_corr", "structure", "r_neigh", "r_neigh_mean", "NTouchingNeighbors","PhysicalSize", "theta","phi", "phi_bin", "theta_bin", "dist_out", "phi_bin_new", "phi_bin_cur"]+stains)
...
for stain in stains:
    ...
    plt.xlabel("theta")
    plt.ylabel("phi")
    fig1.savefig(path_out_im+im+"_"+stain_clean+"_phi_new_theta.png", bbox_inches='tight', dpi=300)
    plt.close(fig1)
